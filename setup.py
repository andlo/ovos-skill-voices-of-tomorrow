...
URL = "https://github.com/andlo/ovos-skill-voices-of-tomorrow"
SKILL_CLAZZ = "VoicesOfTomorrowSkill"  # needs to match __init__.py class name
PYPI_NAME = "ovos-skill-voices-of-tomorrow"  # pip install PYPI_NAME
...
setup(
    name=PYPI_NAME,
    version=get_version(),
    description="OCP skill - plays 'Voices of Tomorrow' audio readings from 365tomorrows.com",
    ...
    keywords="ovos skill ocp common-play podcast audio 365tomorrows scifi",
